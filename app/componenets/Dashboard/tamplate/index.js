...
<div className="bg-white w-full">
	...
	<form className="flex items-center p-5">   
        ...
        <div className="relative w-full">
            ...
            <input type="text" id="voice-search" className="bg-gray-50 border border-gray-500 text-gray-800 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full pl-10 p-2.5  dark:bg-mycolor dark:focus:border-gray-800 text-xxl" placeholder="Search Mockups, Logos, Design Templates..." required />
 ...
 { data.map((data)=>( 
	...
	<Link onClick={()=>dispatch(on())} href={'/dashboard/smartdocs'} className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
