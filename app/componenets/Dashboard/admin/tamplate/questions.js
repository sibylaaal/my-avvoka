...
const handleSubmit = (e) => {
  ...
  fetch('http://localhost:8081/api/admin/create_question', {
    method: 'POST',
    body: JSON.stringify({
      ...
      <div className="flex flex-wrap -mx-3 mb-2">
        ...
        <div className="w-full px-3 mb-6 mt-5 md:mb-0">
          ...
          <div className="relative">
            <select name="type" className="block appearance-none w-full bg-gray-200 border border-gray-200 text-mycolor py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
              <option>none</option>
